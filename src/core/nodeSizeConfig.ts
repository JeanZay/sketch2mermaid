...
export const NODE_SIZE_DEFAULTS: Record<NodeShape, NodeSizeConfig> = {
  ...
  card:                 { width: 140, height: 56, minWidth: 90, minHeight: 44 },
  ...
  display:              { width: 150, height: 56, minWidth: 100, minHeight: 44 },
  dividedProcess:       { width: 140, height: 56, minWidth: 90, minHeight: 44 },
  extract:              { width: 120, height: 90, minWidth: 90, minHeight: 70 },
  forkJoin:             { width: 140, height: 56, minWidth: 90, minHeight: 44 },
  internalStorage:      { width: 150, height: 56, minWidth: 100, minHeight: 44 },
  junction:             { width: 64, height: 64, minWidth: 44, minHeight: 44 },
  linedDocument:        { width: 150, height: 76, minWidth: 110, minHeight: 64 },
  loopLimit:            { width: 140, height: 56, minWidth: 90, minHeight: 44 },
  manualFile:           { width: 150, height: 76, minWidth: 110, minHeight: 64 },
  ...
  odd:                  { width: 140, height: 56, minWidth: 90, minHeight: 44 },
};
