...
describe('Changelog UI Components', () => {
  ...
  describe('ChangelogModal', () => {
    it('renders only unseen entries in auto mode', () => {
      ...
      expect(container.textContent).toContain(CHANGELOG[0].version);
      // Should NOT contain CHANGELOG[1].version in auto mode with only CHANGELOG[0].version unseen
      expect(container.textContent).not.toContain(CHANGELOG[1].version);
